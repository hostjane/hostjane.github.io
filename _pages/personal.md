...
- [x] Licensee: Individual (Natural Person)
- [x] Number of End Users: Up to 1,000 lifetime users
- [x] Non-Commercial (Personal) Use: Permitted
- [x] Commercial Use: Not Permitted
...
This Personal License is between Seller "Licensor" and Buyer "Licensee" for non-commercial use of the End Product.
...
5.1 Under this Personal License, Buyer is not granted any intellectual property rights, title, or interest in the delivered Final Work, which are retained by Seller.
...
5.3 Buyer non-commercial use of Seller's End Product must comply and align with the permitted Non-Commercial Uses in Sections 3 and 4 of this agreement.
